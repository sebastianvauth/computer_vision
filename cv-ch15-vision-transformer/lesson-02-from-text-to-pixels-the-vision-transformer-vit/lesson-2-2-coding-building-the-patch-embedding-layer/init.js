...
(function () {
    const pagePrefix = 'cv-ch15-vision-transformer:lesson-02-from-text-to-pixels-the-vision-transformer-vit:lesson-2-2-coding-building-the-patch-embedding-layer';
