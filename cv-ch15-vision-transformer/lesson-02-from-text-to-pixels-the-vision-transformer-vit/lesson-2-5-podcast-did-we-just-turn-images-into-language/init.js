...
(function () {
    const pagePrefix = 'cv-ch15-vision-transformer:lesson-02-from-text-to-pixels-the-vision-transformer-vit:lesson-2-5-podcast-did-we-just-turn-images-into-language';
