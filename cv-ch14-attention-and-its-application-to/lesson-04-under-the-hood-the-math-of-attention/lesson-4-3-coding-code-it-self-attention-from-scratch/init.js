...
(function () {
    const pagePrefix = 'cv-ch14-attention-and-its-application-to:lesson-04-under-the-hood-the-math-of-attention:lesson-4-3-coding-code-it-self-attention-from-scratch';
